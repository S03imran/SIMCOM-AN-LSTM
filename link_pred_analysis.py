...
if __name__ == '__main__':
    ...
    def plot_roc_curve(y_true, y_pred, file_name):
        ...
        plt.savefig(file_name + '_roc_curve.png')  # Save ROC curve plot
        plt.close()
    ...
    def avg_seq(g, file_name, ratio, algo):
        ...
        for single_iter in range(loop):
            ...
            if single_iter == loop - 1:
                plot_roc_curve(y_test, y_pred_last, file_name)
